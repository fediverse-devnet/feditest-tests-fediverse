...
class ReplyDoubleHopTest:
    ...
    def leader_creates_note(self):
        self.post_uri_on_leader_node = self.leader_node.make_create_note(self.leader_actor_uri, "Nothing much happening.")
    ...
    def follower_creates_reply(self):
        self.reply_uri_on_follower_node = self.follower_node.make_reply(self.follower_actor_uri, "Join us here, we are having fun!")
